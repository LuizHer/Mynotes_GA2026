...
\begin{itemize}
    ...
    \end{lemma}
    Proof (sketch): $(\Rightarrow)$ Let $b\in R$ be integral over $S$, i.e., there exist 
    \begin{equation}
    ...
    Now, if $b_1,\dots, b_m$ are all integral over $S$, we see argue by induction that $S[b_1,\dots, b_{m-1}]$ is finitely generated 
    over $S$. However, since $b_m$ is integral over $S[b_1,\dots, b_{m-1}]$ and $S[b_1,\dots,b_m]$ is finitely generated 
    over $[b_1,\dots, b_{m-1}]$, and then over $S$.\par  
    ...
    \begin{corollary}
        ...
        $S$ is integral over $T$, then $R$ is integral over $T$. 
    \end{corollary}
...
\begin{dang}
\begin{lemma}
    (Noether's normalization lemma). Let $R$ be a finitely generated algebra over $k$. Assume also that $R$ is an integral domain.
    If $R$ has transcende degree $n$ over $k$ (which means that $\partial_k\text{Frac}(R)=n$), then 
    there exist $x_1,\dots, x_n\in R$ algebraicaly independent and such that $R$ is integral dependent
    over $k[x_1,\dots,x_n]$.
\end{lemma}
\end{dang}