...
\begin{equation}
    \varphi^\#:k[X,Y]\to\mathcal{O}_V(V)\cong k[X,Y]/I(V)
\end{equation}
is an isomorphism. However, if $h\in k[X,Y]$ and $h|_V=0$, then $(\varphi^\#)^{-1}(\overline{h})=0$. This means that 
$h(F,G)=0$, where $F=(\varphi^\#)^{-1}(\overline{X}),\; G = (\varphi^\#)^{-1}(\overline{Y})$.
